...
require ('includes/exportTable.inc.php');  
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <h3>รายงานสถานการณ์ โควิด-19</h3> 
                <h4>อัพเดทข้อมูลล่าสุด : <?php echo $UpdateDate;?></h4>
                <h5><u>ที่มาของข้อมูล</u>: API กรมควบคุมโรค กระทรวงสาธารณสุข   <a href="http://covid19.ddc.moph.go.th/th">http://covid19.ddc.moph.go.th/th</a></h5>
                ...
                <div class="col-md-4 col-xs-12">
                    <div class="card" style="background-color:#00572c;">
                        ...
                        <?php 
                            if($NewRecovered > 0){
                                echo "(เพิ่มขึ้น ".$NewRecovered.")"; 
                            }else if($NewConfirmed < 0){
                                echo "(ลดลง ".number_format(substr($NewRecovered,1,strlen($NewRecovered))).")"; 
                            }else{
                                echo "&nbsp;";
                            }
                        ?>                        
                    ...
                    <div class="card" style="background-color:#008080;">
                        ...
                        <?php 
                            if($NewHospitalized > 0){
                                echo "(เพิ่มขึ้น ".$NewHospitalized.")"; 
                            }else if($NewHospitalized < 0){
                                echo "(ลดลง ".number_format(substr($NewHospitalized,1,strlen($NewHospitalized))).")"; 
                            }else{
                                echo "&nbsp;";
                            }
                        ?>
                ...
                <div class="col-md-4 col-xs-12">
                    <div class="card" style="background-color:#808080;">
                        ...
                        <?php 
                            if($NewDeaths > 0){
                                echo "(เพิ่มขึ้น ".$NewDeaths.")"; 
                            }else if($NewDeaths < 0){
                                echo "(ลดลง ".number_format(substr($NewDeaths,1,strlen($NewDeaths))).")"; 
                            }else{
                                echo "&nbsp;";
                            }
                        ?>
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <div class="col-md-12 col-xs-12">
                    <div class="card" style="background-color:#ff00cc;min-height:235px;">
                        ...
                        <?php 
                            if($NewConfirmed > 0){
                                echo "(เพิ่มขึ้น ".number_format($NewConfirmed).")"; 
                            }else if($NewConfirmed < 0){
                                echo "(ลดลง ".number_format(substr($NewConfirmed,1,strlen($NewConfirmed))).")"; 
                            }else{
                                echo "&nbsp;";
                            }
                        ?>
...
<!--แผนที่ & Table -->
    <div class="row">
        ...
        <span><h4>&nbsp;&nbsp;จำนวนผู้ติดเชื้อสะสม จำแนกตามจังหวัดที่รักษาพยาบาล อัพเดทล่าสุด::<?php echo substr($LastData,0,10)?></h4></span>
        <!-- <hr style="border: 2px solid blue;border-radius: 5px;">  -->
        <!--แผนที่ -->
        <div class="col-md-6 col-xs-12">
            <div class="box">
        ...
        <div class="col-md-4 col-xs-12">
                    <div class="card" style="background-color:#0076ec;">
                        <div class="card-body" style="text-align:center;color:#fff;">
                        <h4 class="card-title">เพศชาย</h4>
                        <h2 class="card-text"><?php echo number_format($Gender['Male']);?></h2>
                    </div>
                    </div>
                </div>
                <div class="col-md-4 col-xs-12">
                    <div class="card" style="background-color:#ff00cc;">
                        <div class="card-body" style="text-align:center;color:#fff;">
                        <h4 class="card-title">เพศหญิง</h4>
                        <h2 class="card-text"><?php echo number_format($Gender['Female']);?></h2>
                    </div>
                    </div>
                </div>
                <div class="col-md-4 col-xs-12">
                    <div class="card" style="background-color:#808080;">
                        <div class="card-body" style="text-align:center;color:#fff;">
                        <h4 class="card-title">เพศ(ไม่ระบุ)</h4>
                        <h2 class="card-text"><?php echo number_format($Gender['Unknown']);?></h2>
                    </div>
                    </div>
                </div>
                <span><br></span>
                <div class="col-md-6 col-xs-12">
                    <div class="card" style="background-color:#0000a0;">
                        <div class="card-body" style="text-align:center;color:#fff;">
                        <h4 class="card-title">สัญชาติ ไทย</h4>
                        <h2 class="card-text"><?php echo number_format($Nation['Thai']);?></h2>
                    </div>
                    </div>
                </div>
                <div class="col-md-6 col-xs-12">
                    <div class="card" style="background-color:#808080;">
                        <div class="card-body" style="text-align:center;color:#fff;">
                        <h4 class="card-title">สัญชาติ อื่นๆ</h4>
                        <h2 class="card-text"><?php echo number_format(array_sum($Nation)-$Nation['Thai']);?></h2>
                    </div>
                    </div>
                </div>
                <span><br><br></span>

            <div class="box pull-right" style="height:50px;">
                <?php exportTable("ptable","dataTable");?>
            </div>   
...
<!-- <script src="../reports/charts/js/modules/exporting.js"></script> -->
<script src="themes/js/jquery.dataTables.min.js"></script>
<script src="themes/js/dataTables.bootstrap.min.js"></script>
<script src="themes/js/dataTables.fixedColumns.min.js"></script>
<script src="reports/gis/plugins/map/lib/leaflet.js"></script>
<script src="reports/gis/plugins/map/lib/leaflet-LabelOverlay.js" ></script>
<script src="reports/gis/plugins/map/lib/leaflet.label.js" type="text/javascript"></script>
